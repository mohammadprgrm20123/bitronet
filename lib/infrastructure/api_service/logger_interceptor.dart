...
class PrettyDioLogger extends Interceptor {
  ...
  String _indent([final int tabCount = kInitialTab]) => tabStep * tabCount;

  void _printPrettyMap(
    final Map<dynamic,dynamic> data, {
    final int initialTab = kInitialTab,
  ...
  void _printList(final List<dynamic> list, {final int tabs = kInitialTab}) {
  ...
  void _printUint8List(final Uint8List list, {final int tabs = kInitialTab}) {
    var chunks = [];
  ...
  void _printMapAsTable(final Map<dynamic,dynamic>? map, {final String? header}) {
