...
mixin _$ApiStatus<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(FailureModel message) failure,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(FailureModel message)? failure,
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$ApiStatusCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class _Idle<T> extends ApiStatus<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$ApiStatusCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class _Loading<T> extends ApiStatus<T> {
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({FailureModel message});
}

/// @nodoc
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$ApiStatusCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> extends _Failure<T> {
  ...
  @override
  final FailureModel message;

  @override
  String toString() {
    return 'ApiStatus<$T>.failure(message: $message)';
  }
...
abstract class _Failure<T> extends ApiStatus<T> {
  const factory _Failure(final FailureModel message) = _$FailureImpl<T>;
  const _Failure._() : super._();

  FailureModel get message;
  @JsonKey(ignore: true)
  _$$FailureImplCopyWith<T, _$FailureImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$ApiStatusCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
abstract class _Success<T> extends ApiStatus<T> {
